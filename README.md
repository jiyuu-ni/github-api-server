...
This program is a basic REST server, capable of listening for events which GitHub emits via [GitHub Webhooks](https://docs.github.com/en/developers/webhooks-and-events/webhooks/about-webhooks).
